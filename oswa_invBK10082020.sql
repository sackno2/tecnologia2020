...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2020 a las 17:33:29
...
(4, 878787, '0000-00-00', 6, '9xxxx', 'Nuevo', 'NO'),
...
(1, 'Admin Users', 'Admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'hhskvuf1.jpg', 1, '2020-08-04 08:35:56'),
...
--
ALTER TABLE `inv_cliente`
  MODIFY `cod_cliente` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
...
--
ALTER TABLE `inv_desconexion`
  MODIFY `cod_orden_desco` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `inv_reconexion`
  MODIFY `cod_orden_recon` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
